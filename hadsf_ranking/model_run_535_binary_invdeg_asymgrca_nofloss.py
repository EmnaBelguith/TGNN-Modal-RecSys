...
def config():
    ...
    args.model_save_path = (
        ...
        f'{_l2_tag}{_bs_tag}{_mi_tag}{_dp_tag}{_neg_tag}{_nneg_tag}{_warm_tag}{_nmod_tag}{_nrev_tag}{_grca_tag}_logdeg_normfuse_topicmi_slowsent01_gpool_binary_invdeg_asymgrca_nofloss{_run_tag}.pt'
    )
...
class Net(nn.Module):
    ...
    def calc_loss(self,
        ...
        # Inverse-degree BPR : pondérer par 1/sqrt(deg_pos) pour accélérer les cold items
    ...
    for iter_idx in range(1, params.epoch):
        ...
        for rating_input_nodes, pos_graph, _neg_graph, rating_blocks in pbar:
            ...
            if (not params.no_modal and params.lambda_grca > 0
                ...
                _b    = F.normalize(_mod.detach(), dim=-1)             # asymétrique : h_modal figé
