...
def config():
    ...
    # ── Config fixe dataset ─────────────────────────────────────────────────
    args.dataset_name = 'CDs_HADSF'
    args.dataset_path = '/home/infres/belguith/PFE/processed/CDs_reviews_with_aspects.jsonl'
    ...
    args.model_save_path = (
        ...
        f'{_l2_tag}{_bs_tag}{_mi_tag}{_dp_tag}{_neg_tag}{_nneg_tag}{_warm_tag}{_nmod_tag}{_nrev_tag}{_grca_tag}_logdeg_normfuse_topicmi_slowsent01_gpool_binary_cds{_run_tag}.pt'
    )
...
def train(params):
    ...
    v_feat, t_feat = load_modal_features('/home/infres/belguith/PFE/bm3_data/cds')
    ...
    import pandas as pd
    # CDs_interactions_reviews.csv : IDs alignés sur Musical_reviews_item2id.json (0..4885)
    _df_deg_train = pd.read_csv('/home/infres/belguith/PFE/processed/CDs_interactions_reviews.csv')
    ...
    print("[INIT] item_degree_tensor injected (CDs_interactions_reviews.csv, IDs 0..4885)", flush=True)
