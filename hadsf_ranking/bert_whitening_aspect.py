...
args.dataset_path = '/home/zheng/RatingTopicGraph/filtered_yelp_reviews_aspect_10-50/filtered_yelp_reviews_aspect_10-50.jsonl' 
...
args.pretrained_weight_shortcut = 'bert-base-uncased'  # 修改为您的 BERT 模型路径
model_name = os.path.basename(args.pretrained_weight_shortcut)

args.feat_save_path = os.path.join(
    '/home/infres/belguith/PFE/HADSF_test/checkpoint',
    args.dataset_name,
...
#        nltk.download('punkt')  # 确保 punkt 已下载
        ...
        data_loader = DataLoader(review_dataset, batch_size=32, collate_fn=collate_fn, drop_last=False)
        ...
        review_data_loader = DataLoader(review_level_dataset, batch_size=320, collate_fn=collate_fn, drop_last=True)
