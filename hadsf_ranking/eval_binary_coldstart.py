# -*- coding: utf-8 -*-
# Évaluation finale du modèle binary graph (job 864187)
# Usage : python eval_binary.py
# Différence vs evaluate_model_run.py : utilise rhg_data_binary (edge types 'interacts'/'rev')
...
from model_run_535_binary_coldstart import config, Net, get_logger
...
def test(params, net_class=None):
    ...
    _modal_dir = _dataset_to_modal.get(getattr(params, 'dataset_name', 'Musical_HADSF_coldstart'), 'musical')
