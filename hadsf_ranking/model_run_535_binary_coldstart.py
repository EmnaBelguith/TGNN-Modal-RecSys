...
from rhg_data_binary_coldstart import GraphData
...
def train(params):
    ...
    if not params.no_modal:
        ...
        print(f"[INIT] no_modal=True — item_embedding garde init Xavier aléatoire", flush=True)
...
def test(params):
    import eval_binary_coldstart as _em
