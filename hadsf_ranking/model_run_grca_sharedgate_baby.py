...
from modal_encoder_sharedgate import ModalEncoderSharedGate as ModalEncoder, load_modal_features
    ...
    for iter_idx in range(1, params.epoch):
        ...
        with torch.no_grad():
            ...
            with torch.no_grad():
                ...
                _gate_input = torch.cat([_hv, _ht], dim=-1)
                _ww = torch.softmax(modal_enc.query_shared(_gate_input), dim=-1)
