...
def config():
    ...
    args.model_save_path = (
        ...
        f'{_l2_tag}{_bs_tag}{_mi_tag}{_dp_tag}{_neg_tag}{_nneg_tag}{_warm_tag}{_nmod_tag}{_grca_tag}_logdeg_normfuse_topicmi_slowsent001_gpool{_run_tag}.pt'
    )
...
def train(params):
    ...
    optimizer = torch.optim.Adam([
        ...
        {'params': _sent_params,   'lr': params.train_lr * 0.01},
    ])
    print(f"[LR] No scheduler — LR fixe={params.train_lr}  sent_emb_lr={params.train_lr*0.01} (×0.01)", flush=True)
