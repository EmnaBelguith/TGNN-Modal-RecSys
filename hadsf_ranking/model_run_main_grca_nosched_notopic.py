...
def config():
    ...
    args.model_save_path = (
        ...
        f'{_l2_tag}{_bs_tag}{_mi_tag}{_dp_tag}{_neg_tag}{_nneg_tag}{_warm_tag}{_nmod_tag}{_grca_tag}_logdeg_notopic{_run_tag}.pt'
    )
...
class Net(nn.Module):
    ...
    def calc_loss(self,
        ...
        ed_mi       = torch.tensor(0.0, device=urf.device)
        ranking_loss = torch.tensor(0.0, device=urf.device)
...
def train(params):
    ...
    for iter_idx in range(1, params.epoch):
        ...
        for rating_input_nodes, pos_graph, _neg_graph, rating_blocks in pbar:
            ...
            _eff_lambda_mi = 0.0
            mi_term = torch.tensor(0.0, device=params.device)
        ...
        with torch.no_grad():
            ...
            pass  # no topic encoder in this ablation
        ...
        pass  # no SR eval in notopic ablation
